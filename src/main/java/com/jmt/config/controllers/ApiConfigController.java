...
public class ApiConfigController  implements ExceptionProcessor {
    ...
    public String index(Model model) {
        ...
        com.jmt.config.controllers.ApiConfig config = infoService.get("apiConfig", com.jmt.config.controllers.ApiConfig.class).orElseGet(ApiConfig::new);
    ...
    @PostMapping
    public String save(com.jmt.config.controllers.ApiConfig config, Model model) {
